...
export default {
  ...
  watch: {
    ...
    currentIdDetail: function(value){
      this.currentId = this.currentIdDetail;
      this.getStudentData();
    },

    print: function(value){
      console.log("print is changed:", this.print)
    },
  ...
  methods: {
    ...
    async getMotivation() {
      try {
        const response = await this.$axios.get(
          "http://localhost/process.php?action=getMotivation",
          {
            params: {
              student_id: this.student_id
            }
        ...
        console.log("This is Motivation: ",response);

        this.motivationPath = "http://localhost/" + response.data.motivation_letter[0].motivation_letter;
        console.log("This is motivationPath: ", this.motivationPath);
      } catch (error) {
        console.error(error);
      }
    },
    ...
    async getAdward() {
      try {
        const response = await this.$axios.get(
          "http://localhost/process.php?action=getAdward",
          {
            params: {
              student_id: this.student_id
            }
        ...
        console.log("This is Adward: ",response);

        this.adwardPath = "http://localhost/" + response.data.adward[0].adward;
        console.log("This is adwardPath: ", this.adwardPath);
      } catch (error) {
        console.error(error);
      }
    },
